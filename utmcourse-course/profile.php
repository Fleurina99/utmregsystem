<?php
	...
	$sql="SELECT * FROM `lect` WHERE (`lect_name`='".$uname."')";
...
if (isset($_GET['userid'])) {
  ...
  $sqlupdate="UPDATE `lect` SET `password` = '".$_POST['password']."',`email` = '".$_POST['email']."' WHERE `lect_id` ='".$_POST['userid']."'";
              ...
              <form name="updateuser" action="profile.php" onsubmit="return checkfield1()" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                      	<label for="UserID" class=" gsap-reveal-hero">UserID</label>
                           <input readonly name="userid" type="text" value="<?php echo $row['lect_id']; ?>" />
              		     </div>
                       <div class="form-group">
